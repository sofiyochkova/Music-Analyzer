...
def get_scrobble_stats(tracks_data: pd.DataFrame, albums_data: pd.DataFrame):
    if not tracks_data or not albums_data:
        return None

    # more_than_one_scrobble = tracks_data[["playcount" > 1]]
